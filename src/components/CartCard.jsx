...
export const CartCard = ({ product, cart }) => {
  ...
  return (
    <>
      {cart ? (
        <div className="flex justify-between items-center shadow-md border border-b-4 py-2 px-4 rounded-md my-8 mx-4 hover:bg-gray-100">
          ...
          <p className="font-bold px-3">Price: {product.price}$</p>
          <button
